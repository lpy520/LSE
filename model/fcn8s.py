...
class FCN8s(nn.Module):
    ...
    def CrossEntropy2d(self, predict, target, weight=None, size_average=True):
        ...
        loss = F.cross_entropy(predict, target, weight=weight, size_average=size_average,reduce=False) 
        return loss    
            
def VGG16_FCN8s(num_classes=4, init_weights=None, restore_from=None):
